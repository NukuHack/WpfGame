...
namespace VoidVenture
{
    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        public int defaultTerrainSize = 1000;

        public int defaultTerrainOffsetY = 10;
        public int defaultTerrainOffsetX = 1000;
        ...
        public void RegenMap()
        {
            ...
            offsetX = defaultTerrainOffsetX;
            offsetY = defaultTerrainOffsetY;
        ...
        private void BeginTerrainGenerating()
        {
            ...
            //noise gen
            double waterY = (defaultTerrainSize - WaterLevel) * Scale - offsetY;
            ...
            Parallel.For(0, currentWidth, x =>
            {
                ...
                columnHeights[x] = normalizedValue * defaultTerrainSize * Scale - offsetY;
